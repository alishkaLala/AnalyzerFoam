                ...
                if (true)  // sometimes crash
                        {
                                ...
                                pr1 = new Canal_contur(v_plane,v_can,11,a,b,k1,k2);//запускати окремими потоками
                                pr2 = new Canal_contur(h_plane,h_can,11,a,b,k1,k2);//запускати окремими потоками
                                pr3 = new Canal_contur(s_plane,s_can,11,a,b,k1,k2);//запускати окремими потоками
